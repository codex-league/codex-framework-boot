...
public final class WechartAuthenticationProvider implements AuthenticationProvider {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		WechartGrantAuthenticationToken wechartGrantAuthenticationToken =
				(WechartGrantAuthenticationToken) authentication;

		OAuth2ClientAuthenticationToken clientPrincipal =
				OAuth2AuthenticationProviderUtils.getAuthenticatedClientElseThrowInvalidClient(wechartGrantAuthenticationToken);
		...
		try {
			userDetails = userDetailsService.loadUserByCode(wechartGrantAuthenticationToken.getCode());
		...
		DefaultOAuth2TokenContext.Builder tokenContextBuilder = DefaultOAuth2TokenContext.builder()
				...
				.authorizationGrant(wechartGrantAuthenticationToken);
